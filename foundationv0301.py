...
def calculate_basket_total():
    ...
    subtotal_label = tk.Label(labelframe, text=f"Subtotal: {round(calculate_total,2)}£")
    subtotal_label.pack()
    discount_label = tk.Label(labelframe, text=f"Discount: ")
    discount_label.pack()
    tax_label = tk.Label(labelframe, text=f"Tax(%18)")
    tax_label.pack()
    total = tk.Label(labelframe, text=f"Total: ")
    total.pack()
...
main_pos_name.title("Foundation Project Market with GUI version 0.3.0.1")
